// AOT plugin tells about what entry module and ts config to use. Slims down the application to be deployed.
// Reduces the size of build to be accessed when the web is browsed.
